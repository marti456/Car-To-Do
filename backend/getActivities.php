...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $activities_check_query = "SELECT activities.id, activities.name, activities.description, activities.endTime, types.type_name FROM activities
     LEFT JOIN types ON activities.type_id = types.id WHERE user_id = '$user_id'" or die("database error:". mysqli_error($db));
